...
public class Constants {
    ...
    public static final String VERTEX_SHADER_STANDARD_PATH = "/shaders/vs_standard.txt";
    public static final String FRAGMENT_SHADER_STANDARD_PATH = "/shaders/vs_standard.txt";
